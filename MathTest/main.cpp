...
int main()
{
	...
	assert(bezier(  0, { 0,0,0 }, { 1,0,0 }, { 2,0,0 }, { 4,0,0 }).x == 0);
	assert(bezier(  1, { 0,0,0 }, { 1,0,0 }, { 2,0,0 }, { 4,0,0 }).x == 3);
	assert(bezier(0.5, { 0,0,0 }, { 1,0,0 }, { 2,0,0 }, { 4,0,0 }).x == 1.5);
